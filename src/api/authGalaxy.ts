...
export const getVerifyAuthQueryOptions = <TData = Awaited<ReturnType<typeof verifyAuth>>, TError = ErrorType<void>>(params: VerifyAuthParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof verifyAuth>>, TError, TData>, request?: SecondParameter<typeof customInstance>}
) => {
...
export const useVerifyAuth = <TData = Awaited<ReturnType<typeof verifyAuth>>, TError = ErrorType<void>>(
 params: VerifyAuthParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof verifyAuth>>, TError, TData>, request?: SecondParameter<typeof customInstance>}
...
export const getGetLoginQueryOptions = <TData = Awaited<ReturnType<typeof getLogin>>, TError = ErrorType<void>>(params: GetLoginParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getLogin>>, TError, TData>, request?: SecondParameter<typeof customInstance>}
) => {
...
export const useGetLogin = <TData = Awaited<ReturnType<typeof getLogin>>, TError = ErrorType<void>>(
 params: GetLoginParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getLogin>>, TError, TData>, request?: SecondParameter<typeof customInstance>}
...
export const getGetLogoutQueryOptions = <TData = Awaited<ReturnType<typeof getLogout>>, TError = ErrorType<void>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getLogout>>, TError, TData>, request?: SecondParameter<typeof customInstance>}
) => {
...
export const useGetLogout = <TData = Awaited<ReturnType<typeof getLogout>>, TError = ErrorType<void>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getLogout>>, TError, TData>, request?: SecondParameter<typeof customInstance>}
...
export const createPlaygroundUser = (
 ...
 options?: SecondParameter<typeof customInstance>,) => {
      ...
      {url: `/api/playground`, method: 'post',
      headers: {'Content-Type': 'application/json', },
...
export const getCreatePlaygroundUserMutationOptions = <TError = ErrorType<unknown>,
    
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createPlaygroundUser>>, TError,{data: ControllersCreatePlaygroundInput}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof createPlaygroundUser>>, TError,{data: ControllersCreatePlaygroundInput}, TContext> => {
 const {mutation: mutationOptions, request: requestOptions} = options ?? {};

      


      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createPlaygroundUser>>, {data: ControllersCreatePlaygroundInput}> = (props) => {
          const {data} = props ?? {};
   ...
   return  { mutationFn, ...mutationOptions }}
    ...
    export type CreatePlaygroundUserMutationResult = NonNullable<Awaited<ReturnType<typeof createPlaygroundUser>>>
 ...
 * @summary Create Playground User
 */
export const useCreatePlaygroundUser = <TError = ErrorType<unknown>,
