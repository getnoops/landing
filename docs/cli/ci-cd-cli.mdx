...
`Why do I need to create a configuration file and store it in my repository if I've already defined resources in No_Ops?`
  ...
  - This allows you to:
    - Use environment variables in your configuration file (eg. image name, database URL, etc.)
...
:::note[Next step]
You can now [learn more about the No_Ops CLI](./learn-cli) or [see how to promote deployments to another environment](../promoting-deployments).
:::