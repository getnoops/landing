...
Once you have [created an organisation](../administration/create-organisation), you can connect your AWS account to it.
...
:::note[Next step]
You are now ready to [create your first environment](./create-environment)!
:::
