...
:::note
`this` is a special keyword that accesses a specified `noops.yaml` configuration file.
:::
...
:::note[Next step]
You can now [see how to promote deployments to another environment](../promoting-deployments).
:::
